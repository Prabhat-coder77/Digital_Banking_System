...
public class TransactionEventConsumer {
     ...
     private static final String TRANSACTION_OTP_GENERATED_TOPIC = "transaction.generated.topic";
    ...
    public void consumeVerificationRequired(@Payload Map<String,Object> payload) {
        ...
        try{
            ...
            log.info("OTP generated for transaction: {} expiry in {} min",transactionId,OTP_EXPIRY_MINUTES);
